# Style Spec — 01 swiftlogix-warm

The first, verified library entry (BUILD.md Rule 1: perfect one before you do twenty).
This is a real, load-bearing spec — the pipeline uses it when a brief matches `best_for`.
...
- **card_padding:** ~34px
- **shadow:** soft, large, low-opacity, downward (e.g. 0 40px 80px -30px rgba(26,30,44,.4)); never hard/tight
